 ...
 */
function platinumbible_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Platinum Bible default saturation level.
	 *
	 * @since Platinum Bible 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'platinumbible_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.platinumbible-front-page) .entry-title,
...
.colors-custom .platinumbible-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.platinumbible-front-page .panel-content .recent-posts article,
...
.colors-custom.platinumbible-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Platinum Bible custom colors CSS.
	 *
	 * @since Platinum Bible 1.0
	 *
	 ...
	 */
	return apply_filters( 'platinumbible_custom_colors_css', $css, $hue, $saturation );
}
